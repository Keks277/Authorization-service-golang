...
func (x *RegistreResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegistreResponse) ProtoMessage() {}

func (x *RegistreResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegistreResponse.ProtoReflect.Descriptor instead.
func (*RegistreResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{1}
}

func (x *RegistreResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x73, 0x74, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17,
	...
	0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x65, 0x52, 0x65, 0x73, 0x70,
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*RegistreResponse)(nil), // 1: auth.RegistreResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	1, // 3: auth.Auth.Register:output_type -> auth.RegistreResponse
