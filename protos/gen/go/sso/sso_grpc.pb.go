...
type AuthClient interface {
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegistreResponse, error)
...
func (c *authClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegistreResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegistreResponse)
...
type AuthServer interface {
	Register(context.Context, *RegisterRequest) (*RegistreResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterRequest) (*RegistreResponse, error) {
